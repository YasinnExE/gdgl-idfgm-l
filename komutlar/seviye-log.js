...
.setDescription(`<:ReddetmekPng:807560290035564605> Bu Komutu Kullanmak İçin; \`ADMINISTRATOR\` Yetkisine Sahip Olmalısın!`))
   ...
   if(args[0] == "sıfırla") {
    ...
    return message.channel.send(`<:OnayPng:807560289196179486> Seviye-Log sıfırlandı!`);
   ...
   if (args[0]) {
      ...
      message.channel.send(`<:OnayPng:807560289196179486> Seviye Log Kanalı Ayarlandı! Ayarlanan Kanal: <#${akanal.id}> Sıfırlamak için !seviye-log sıfırla`)           

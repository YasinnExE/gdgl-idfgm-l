...
let link = `[Destek Sunucusu!](https://discord.gg/Ts4twkEDhW)`
...
.addField(`Ayarlanan Rolleri Görmek:`, `\`${p}seviyerolleri\``)) 
      ...
      if(args[0] == 'temizle' || args[0] == "clear") {
        ...
        return message.channel.send(`<:OnayPng:807560289196179486> Seviye-Rol Başarıyla Sıfırlandı!\n`)

      }

      if(isNaN(args[1])) return message.channel.send(`<:ReddetmekPng:807560290035564605> Seviye bir sayı olmalı!`)

...
module.exports.run = async (client, message, args) => {
	 if(message.author.id !== message.guild.owner.user.id) return message.reply('<:ReddetmekPng:807560290035564605> Bu komutu kullanabilmek için **Sunucu Sahibi** olmalısın!')
